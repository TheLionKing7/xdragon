...
const KNOWN_SERVICE_PATTERNS: { pattern: RegExp; name: string; category: ServiceCategory; hint: string }[] = [
  ...
  // ── Archon Ecosystem ────────────────────────────────────────────────────
  { pattern: /ARCHON_BACKEND|ARCHON_NEXUS/i,  name: "Archon Backend",       category: "ai_gateway",    hint: "AI orchestration backend (Fly.io)" },
  { pattern: /MEMSIGHT_URL|HINDSIGHT/i,       name: "MemSight",             category: "ai_gateway",    hint: "Agent long-term memory API" },
  { pattern: /XDRAGON_URL/i,                  name: "xDragon Lightning",    category: "ai_gateway",    hint: "Ollama on Lightning.ai GPU Studio" },
  { pattern: /XORBIT_URL|FLASK_PORT/i,        name: "xOrbit Engine",        category: "ai_gateway",    hint: "Market simulation engine" },
  { pattern: /HYPERSPACE_NODE/i,              name: "Hyperspace Node",      category: "other",         hint: "P2P idle-compute daemon" },
  { pattern: /IDENTITY_SHIELD/i,              name: "Identity Shield",      category: "identity",      hint: "Haskell agent persona lock" },
  { pattern: /CEREBRAS/i,                     name: "Cerebras",             category: "ai_gateway",    hint: "Ultra-fast cloud inference" },
  { pattern: /FIVECLAW|CASHCLAW|MOLTLAUNCH/i, name: "FiveClaw",             category: "other",         hint: "Autonomous earning agent (Moltlaunch)" },
  { pattern: /FLY_API|FLY_APP/i,              name: "Fly.io",               category: "hosting",       hint: "Edge deployment (Archon Nexus)" },
  { pattern: /LIGHTNING_AI|LITNG/i,           name: "Lightning.ai",         category: "hosting",       hint: "GPU Studio for xDragon" },
  { pattern: /RAILWAY_TOKEN|RAILWAY_API/i,    name: "Railway",              category: "hosting",       hint: "Worker + API deployment" },
  { pattern: /DEERFLOW/i,                     name: "DeerFlow",             category: "ai_gateway",    hint: "Deep-research agent pipeline" },
];
...
// ─────────────────────────────────────────────────────────────
// SEED DATA
// Ventures = products designed, built & maintained by us.
// Services = third-party or ecosystem integrations wired into
//            each venture. External ecosystem projects
//            (FiveClaw, xOrbit, MemSight, Hyperspace) are
//            integrated SERVICES, never standalone ventures.
// ─────────────────────────────────────────────────────────────
  ...
  return [
    // ── 1. ARCHON NEXUS ─────────────────────────────────────
    {
      ...
      services: [
        ...
        { id: "flyio",        name: "Fly.io",              category: "hosting",       status: "unconfigured", description: "Edge deployment for Archon backend",       dashboardUrl: "https://fly.io/dashboard",                  docsUrl: "https://fly.io/docs",                credentials: [{ key:"FLY_API_TOKEN", value:"", masked:true }, { key:"FLY_APP_NAME", value:"", masked:true }],                                                                    tags: ["hosting"],           dependsOn: [] },
        { id: "railway",      name: "Railway",             category: "hosting",       status: "unconfigured", description: "Worker + secondary API deployment",        dashboardUrl: "https://railway.app",                       docsUrl: "https://docs.railway.app",           credentials: [{ key:"RAILWAY_TOKEN", value:"", masked:true }],                                                                                                                    tags: ["hosting"],           dependsOn: [] },
        ...
        { id: "discord",      name: "Discord",             category: "communication", status: "unconfigured", description: "War room bot notifications",                dashboardUrl: "https://discord.com/developers",            credentials: [{ key:"BOT_TOKEN", value:"", masked:true }],                                                                                                                        tags: [],                    dependsOn: [] },
        { id: "gdrive",       name: "Google Drive",        category: "storage",       status: "unconfigured", description: "Document & report storage",                 dashboardUrl: "https://console.cloud.google.com",          credentials: [{ key:"CLIENT_ID", value:"", masked:true }, { key:"CLIENT_SECRET", value:"", masked:true }],                                                                   tags: [],                    dependsOn: [] },
        ...
        // Ecosystem integrations wired into Archon
        { id: "memsight",     name: "MemSight",            category: "ai_gateway",    status: "unconfigured", description: "Agent long-term memory API (Hindsight)",    dashboardUrl: "http://localhost:8888",                     docsUrl: "https://github.com/memsight",        credentials: [{ key:"MEMSIGHT_URL", value:"http://localhost:8888", masked:false }, { key:"HINDSIGHT_API_KEY", value:"", masked:true }],                                              tags: ["memory","ai"],       dependsOn: [] },
        { id: "xorbit",       name: "xOrbit Engine",       category: "ai_gateway",    status: "unconfigured", description: "Multi-agent market simulation engine",      dashboardUrl: "http://localhost:5001",                     docsUrl: "https://github.com/xorbit",          credentials: [{ key:"XORBIT_URL", value:"http://localhost:5001", masked:false }, { key:"XORBIT_API_KEY", value:"", masked:true }],                                                    tags: ["simulation","ai"],   dependsOn: [] },
        { id: "fiveclaw",     name: "FiveClaw",            category: "other",         status: "unconfigured", description: "Autonomous earning agent (Moltlaunch tasks)", dashboardUrl: "http://localhost:3777",                    docsUrl: "https://github.com/fiveclaw",        credentials: [{ key:"FIVECLAW_URL", value:"http://localhost:3777", masked:false }, { key:"MOLTLAUNCH_API_KEY", value:"", masked:true }],                                              tags: ["agent","earning"],   dependsOn: ["memsight"] },
        { id: "hyperspace",   name: "Hyperspace Node",     category: "other",         status: "unconfigured", description: "P2P idle-compute daemon (earn while idle)",  dashboardUrl: "http://localhost:9099",                    docsUrl: "https://github.com/hyperspace-x-node", credentials: [{ key:"HYPERSPACE_NODE_URL", value:"http://localhost:9099", masked:false }, { key:"HYPERSPACE_GATEWAY_KEY", value:"", masked:true }],                              tags: ["compute","p2p"],     dependsOn: [] },
        { id: "cerebras",     name: "Cerebras",            category: "ai_gateway",    status: "unconfigured", description: "Ultra-fast cloud LLM inference",            dashboardUrl: "https://cloud.cerebras.ai",                 docsUrl: "https://inference-docs.cerebras.ai", credentials: [{ key:"CEREBRAS_API_KEY", value:"", masked:true }],                                                                                                                          tags: ["ai","inference"],    dependsOn: [] },
      ]
    },
    ...
    // ── 2. XDRAGON STUDIO ───────────────────────────────────
    {
      ...
      services: [
        { id: "xd_ollama",        name: "Ollama (Local)",      category: "ai_gateway",    status: "active",         description: "Local LLM inference server",               dashboardUrl: "http://localhost:11434",                    credentials: [],                                                                                                                                                          tags: ["local","llm"],       dependsOn: [] },
        { id: "xd_lightning",     name: "Lightning.ai",        category: "hosting",       status: "unconfigured", description: "GPU Studio cloud hosting for xDragon",     dashboardUrl: "https://lightning.ai",                      docsUrl: "https://lightning.ai/docs",          credentials: [{ key:"LIGHTNING_AI_KEY", value:"", masked:true }, { key:"XDRAGON_URL", value:"", masked:false }],                                                              tags: ["gpu","hosting"],     dependsOn: [] },
        { id: "xd_github",        name: "GitHub",              category: "other",         status: "unconfigured", description: "Source code hosting and CI",                dashboardUrl: "https://github.com",                        credentials: [{ key:"PERSONAL_ACCESS_TOKEN", value:"", masked:true }, { key:"USERNAME", value:"", masked:true }],                                                          tags: ["git"],               dependsOn: [] },
        { id: "xd_memsight",      name: "MemSight",            category: "ai_gateway",    status: "unconfigured", description: "Long-term agent memory for xDragon agents", dashboardUrl: "http://localhost:8888",                     credentials: [{ key:"MEMSIGHT_URL", value:"http://localhost:8888", masked:false }],                                                                                         tags: ["memory","ai"],       dependsOn: [] },
        { id: "xd_xorbit",        name: "xOrbit Engine",       category: "ai_gateway",    status: "unconfigured", description: "Market simulation data feed",               dashboardUrl: "http://localhost:5001",                     credentials: [{ key:"XORBIT_URL", value:"http://localhost:5001", masked:false }],                                                                                          tags: ["simulation"],        dependsOn: [] },
        { id: "xd_identity",      name: "Identity Shield",     category: "identity",      status: "unconfigured", description: "Haskell agent persona lock & auth",         dashboardUrl: "http://localhost:7777",                     credentials: [{ key:"IDENTITY_SHIELD_URL", value:"http://localhost:7777", masked:false }, { key:"SHIELD_SECRET", value:"", masked:true }],                         tags: ["identity","security"], dependsOn: [] },
        { id: "xd_hyperspace",    name: "Hyperspace Node",     category: "other",         status: "unconfigured", description: "Idle GPU compute contribution",             dashboardUrl: "http://localhost:9099",                     credentials: [{ key:"HYPERSPACE_NODE_URL", value:"http://localhost:9099", masked:false }],                                                                                 tags: ["compute","p2p"],     dependsOn: ["xd_lightning"] },
        { id: "xd_deerflow",      name: "DeerFlow",            category: "ai_gateway",    status: "unconfigured", description: "Deep-research agent pipeline",              dashboardUrl: "http://localhost:8000",                     credentials: [{ key:"DEERFLOW_URL", value:"http://localhost:8000", masked:false }],                                                                                         tags: ["research","ai"],     dependsOn: [] },
        { id: "xd_cerebras",      name: "Cerebras",            category: "ai_gateway",    status: "unconfigured", description: "Ultra-fast cloud inference fallback",       dashboardUrl: "https://cloud.cerebras.ai",                 credentials: [{ key:"CEREBRAS_API_KEY", value:"", masked:true }],                                                                                                         tags: ["ai","inference"],    dependsOn: [] },
      ]
    },
    ...
    // ── 3. SABIWORK AI ──────────────────────────────────────
    {
      ...
      services: [
        ...
        { id: "sw_railway",       name: "Railway",             category: "hosting",       status: "unconfigured", description: "Backend deployment",                        dashboardUrl: "https://railway.app",                       credentials: [{ key:"RAILWAY_TOKEN", value:"", masked:true }],                                                                                                            tags: ["hosting"],           dependsOn: [] },
        ...
        { id: "sw_spark",         name: "Spark Messenger",     category: "communication", status: "unconfigured", description: "Internal team messaging",                   dashboardUrl: "https://spark.archonnexus.com",             credentials: [],                                                                                                                                                          tags: ["messaging"],         dependsOn: [] },
        { id: "sw_memsight",      name: "MemSight",            category: "ai_gateway",    status: "unconfigured", description: "Workspace long-term memory layer",          dashboardUrl: "http://localhost:8888",                     credentials: [{ key:"MEMSIGHT_URL", value:"http://localhost:8888", masked:false }],                                                                                         tags: ["memory","ai"],       dependsOn: [] },
        { id: "sw_fiveclaw",      name: "FiveClaw",            category: "other",         status: "unconfigured", description: "Autonomous task agent (Moltlaunch)",        dashboardUrl: "http://localhost:3777",                     credentials: [{ key:"FIVECLAW_URL", value:"http://localhost:3777", masked:false }],                                                                                         tags: ["agent"],             dependsOn: ["sw_memsight"] },
      ]
    },
    ...
    // ── 4. ERRANDX ──────────────────────────────────────────
    {
      ...
      services: [
        { id: "ex_supabase",      name: "Supabase",            category: "database",      status: "unconfigured", description: "Order + delivery database",                 dashboardUrl: "https://supabase.com/dashboard",            credentials: [{ key:"PROJECT_URL", value:"", masked:true }, { key:"ANON_KEY", value:"", masked:true }],                                                              tags: ["database"],          dependsOn: [] },
        ...
        { id: "ex_geniepay",      name: "GeniePay",            category: "payment",       status: "unconfigured", description: "Internal Archon payment gateway",           dashboardUrl: "https://geniepay.archonnexus.com",          credentials: [],                                                                                                                                                          tags: ["payments"],          dependsOn: [] },
        { id: "ex_twilio",        name: "Twilio SMS",          category: "communication", status: "unconfigured", description: "Delivery SMS & OTP alerts",                 dashboardUrl: "https://console.twilio.com",                credentials: [{ key:"ACCOUNT_SID", value:"", masked:true }, { key:"AUTH_TOKEN", value:"", masked:true }],                                                              tags: [],                    dependsOn: [] },
        { id: "ex_memsight",      name: "MemSight",            category: "ai_gateway",    status: "unconfigured", description: "Delivery history & user memory",            dashboardUrl: "http://localhost:8888",                     credentials: [{ key:"MEMSIGHT_URL", value:"http://localhost:8888", masked:false }],                                                                                         tags: ["memory"],            dependsOn: [] },
        { id: "ex_openrouter",    name: "OpenRouter",          category: "ai_gateway",    status: "unconfigured", description: "AI dispatch routing intelligence",          dashboardUrl: "https://openrouter.ai/keys",                credentials: [{ key:"API_KEY", value:"", masked:true }],                                                                                                                  tags: ["ai"],                dependsOn: [] },
      ]
    },
    ...
    // ── 5. GENIEPAY ─────────────────────────────────────────
    {
      ...
      services: [
        { id: "gp_flutterwave",   name: "Flutterwave",         category: "payment",       status: "unconfigured", description: "African payment gateway",                  dashboardUrl: "https://dashboard.flutterwave.com",         credentials: [{ key:"PUBLIC_KEY", value:"", masked:true }, { key:"SECRET_KEY", value:"", masked:true }],                                                              tags: ["payments"],          dependsOn: [] },
        { id: "gp_paystack",      name: "Paystack",            category: "payment",       status: "unconfigured", description: "African payments (NG/GH/ZA)",               dashboardUrl: "https://dashboard.paystack.com",            credentials: [{ key:"PUBLIC_KEY", value:"", masked:true }, { key:"SECRET_KEY", value:"", masked:true }],                                                              tags: ["payments"],          dependsOn: [] },
        { id: "gp_stripe",        name: "Stripe",              category: "payment",       status: "unconfigured", description: "Global card processing",                    dashboardUrl: "https://dashboard.stripe.com",              credentials: [{ key:"SECRET_KEY", value:"", masked:true }],                                                                                                               tags: ["payment"],           dependsOn: [] },
        { id: "gp_supabase",      name: "Supabase",            category: "database",      status: "unconfigured", description: "Transaction ledger database",               dashboardUrl: "https://supabase.com/dashboard",            credentials: [{ key:"PROJECT_URL", value:"", masked:true }, { key:"ANON_KEY", value:"", masked:true }],                                                              tags: ["database"],          dependsOn: [] },
        { id: "gp_cbn",           name: "CBN API (NIBSS)",     category: "other",         status: "unconfigured", description: "Central Bank settlement rails",             dashboardUrl: "https://www.cbn.gov.ng",                    credentials: [{ key:"NIBSS_CLIENT_ID", value:"", masked:true }, { key:"NIBSS_SECRET", value:"", masked:true }],                                                      tags: ["regulation"],        dependsOn: [] },
        { id: "gp_geniechain",    name: "GenieChain",          category: "blockchain",    status: "unconfigured", description: "On-chain settlement fallback",              dashboardUrl: "https://geniechain.archonnexus.com",        credentials: [],                                                                                                                                                          tags: ["blockchain"],        dependsOn: [] },
      ]
    },
    ...
    // ── 6. GENIECHAIN ───────────────────────────────────────
    {
      ...
      services: [
        { id: "gc_alchemy",       name: "Alchemy",             category: "blockchain",    status: "unconfigured", description: "RPC node provider (Ethereum/Polygon)",      dashboardUrl: "https://dashboard.alchemy.com",             credentials: [{ key:"API_KEY", value:"", masked:true }],                                                                                                                  tags: ["rpc"],               dependsOn: [] },
        { id: "gc_infura",        name: "Infura",              category: "blockchain",    status: "unconfigured", description: "Ethereum RPC fallback",                     dashboardUrl: "https://infura.io/dashboard",               credentials: [{ key:"PROJECT_ID", value:"", masked:true }, { key:"SECRET", value:"", masked:true }],                                                                  tags: ["rpc"],               dependsOn: [] },
        { id: "gc_ipfs",          name: "IPFS/Pinata",         category: "storage",       status: "unconfigured", description: "Decentralised file storage",                dashboardUrl: "https://app.pinata.cloud",                  credentials: [{ key:"API_KEY", value:"", masked:true }, { key:"SECRET_KEY", value:"", masked:true }],                                                                   tags: ["ipfs","storage"],    dependsOn: [] },
        { id: "gc_etherscan",     name: "Etherscan",           category: "monitoring",    status: "unconfigured", description: "Block explorer API",                        dashboardUrl: "https://etherscan.io/myapikey",             credentials: [{ key:"API_KEY", value:"", masked:true }],                                                                                                                  tags: ["blockchain"],        dependsOn: ["gc_alchemy"] },
        { id: "gc_supabase",      name: "Supabase",            category: "database",      status: "unconfigured", description: "Off-chain metadata store",                  dashboardUrl: "https://supabase.com/dashboard",            credentials: [{ key:"PROJECT_URL", value:"", masked:true }, { key:"ANON_KEY", value:"", masked:true }],                                                              tags: ["database"],          dependsOn: [] },
      ]
    },

    // ── 7. GENIEID ──────────────────────────────────────────
    {
      id: "genieid", name: "GenieID", type: "Identity & Compliance Infrastructure", accent: T.purple,
      services: [
        { id: "gi_auth0",         name: "Auth0",               category: "identity",      status: "unconfigured", description: "Authentication & SSO platform",             dashboardUrl: "https://manage.auth0.com",                  credentials: [{ key:"CLIENT_ID", value:"", masked:true }, { key:"CLIENT_SECRET", value:"", masked:true }, { key:"DOMAIN", value:"", masked:false }],               tags: ["auth"],              dependsOn: [] },
        { id: "gi_twilio",        name: "Twilio",              category: "communication", status: "unconfigured", description: "SMS and 2FA OTP delivery",                  dashboardUrl: "https://console.twilio.com",                credentials: [{ key:"ACCOUNT_SID", value:"", masked:true }, { key:"AUTH_TOKEN", value:"", masked:true }],                                                              tags: [],                    dependsOn: [] },
        { id: "gi_civic",         name: "Civic",               category: "identity",      status: "unconfigured", description: "KYC identity verification",                  dashboardUrl: "https://dashboard.civic.com",               credentials: [{ key:"APP_ID", value:"", masked:true }, { key:"SECRET", value:"", masked:true }],                                                                      tags: ["kyc"],               dependsOn: ["gi_auth0"] },
        { id: "gi_nin",           name: "NIN Registry (NIMC)", category: "identity",      status: "unconfigured", description: "Nigerian National ID verification",          dashboardUrl: "https://nimc.gov.ng",                       credentials: [{ key:"CLIENT_ID", value:"", masked:true }, { key:"SECRET", value:"", masked:true }],                                                                      tags: ["kyc","nigeria"],     dependsOn: [] },
        { id: "gi_identity",      name: "Identity Shield",     category: "identity",      status: "unconfigured", description: "Agent persona lock (Archon ecosystem)",      dashboardUrl: "http://localhost:7777",                     credentials: [{ key:"IDENTITY_SHIELD_URL", value:"http://localhost:7777", masked:false }, { key:"SHIELD_SECRET", value:"", masked:true }],                         tags: ["identity","security"], dependsOn: [] },
        { id: "gi_supabase",      name: "Supabase",            category: "database",      status: "unconfigured", description: "Identity records store",                    dashboardUrl: "https://supabase.com/dashboard",            credentials: [{ key:"PROJECT_URL", value:"", masked:true }, { key:"ANON_KEY", value:"", masked:true }],                                                              tags: ["database"],          dependsOn: [] },
      ]
    },
  ];
}
